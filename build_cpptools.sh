...
cd $CPPRESTSDK_BUILD
$CMAKE $CPPRESTSDK_SRC/Release -DCMAKE_INSTALL_PREFIX=$CPPRESTSDK_PREFIX $CMAKE_RELEASE_BUILD $CMAKE_USE_CLANG -DBOOST_ROOT=/local/projects/3p/boost/ -DBoost_USE_MULTITHREADED=ON
make $BUILD_OPTS
