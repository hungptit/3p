...
$CMAKE $LucenePlusPlus_FOLDER -DCMAKE_INSTALL_PREFIX=$LucenePlusPlus_PREFIX $CMAKE_RELEASE_BUILD $CMAKE_USE_CLANG -DBOOST_ROOT=$BOOST_PREFIX -DBoost_INCLUDE_DIR=$BOOST_PREFIX/include -DBoost_LIBRARY_DIR=$BOOST_PREFIX/lib -DLUCENE_USE_STATIC_BOOST_LIBS=true
